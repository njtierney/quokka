...
I couldn't set `width.cutoff` to Inf, so I just set it to a largish number.
...
pw_test <- pairwise.t.test(airquality$Ozone, airquality$`Month of the year in the english language and entered in today on the 2017-09-18`)
